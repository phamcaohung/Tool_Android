...
# static fields
.field public static final DEFAULT_DATE_FORMAT:Ljava/lang/String; = "MMM dd yyyy"

.field public static final DEFAULT_RECENT_DATE_FORMAT:Ljava/lang/String; = "MMM dd HH:mm"

.field public static final REGEX:Ljava/lang/String; = "(d|-){1}\\s+\\[([-A-Z]+)\\]\\s+(\\S+)\\s+(\\d+)\\s+(\\S+\\s+\\S+\\s+((\\d+:\\d+)|(\\d{4})))\\s+(.*)"
