...
# static fields
.field public static final DEFAULT_DATE_FORMAT:Ljava/lang/String; = "yyyy/MM/dd HH:mm"

.field public static final FILE_LIST_REGEX:Ljava/lang/String; = "\\S+\\s+\\S+\\s+\\S+\\s+\\S+\\s+\\S+\\s+[FV]\\S*\\s+\\S+\\s+\\S+\\s+(PS|PO|PO-E)\\s+(\\S+)\\s*"

.field public static final FILE_LIST_TYPE:I = 0x0

.field public static final JES_LEVEL_1_LIST_REGEX:Ljava/lang/String; = "(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+)\\s*"

.field public static final JES_LEVEL_1_LIST_TYPE:I = 0x3

.field public static final JES_LEVEL_2_LIST_REGEX:Ljava/lang/String; = "(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+)\\s+(\\S+).*"

.field public static final JES_LEVEL_2_LIST_TYPE:I = 0x4

.field public static final MEMBER_LIST_REGEX:Ljava/lang/String; = "(\\S+)\\s+\\S+\\s+\\S+\\s+(\\S+)\\s+(\\S+)\\s+\\S+\\s+\\S+\\s+\\S+\\s+\\S+\\s*"

.field public static final MEMBER_LIST_TYPE:I = 0x1

.field public static final UNIX_LIST_TYPE:I = 0x2

.field public static final UNKNOWN_LIST_TYPE:I = -0x1


# instance fields
.field public isType:I

.field public unixFTPEntryParser:Lorg/apache/commons/net/ftp/parser/UnixFTPEntryParser;
